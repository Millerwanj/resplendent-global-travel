...
- Expanded the Japan journal entry with route pacing, seasonal planning, rail logistics and cultural guidance.
- Expanded the Dubai journal entry with neighbourhood, weather, desert, leisure and executive-travel planning.
- Linked the Japan, Dubai and Maasai Mara destination cards directly to their matching journal entries.
- Refreshed journal metadata, Article schema modification dates and sitemap dates.
- Standardised active asset and visible release versions to v9.6.4.
- Preserved the complete v9.6.3 enquiry, proposal, quotation, acceptance and invoice pipeline without operational changes.
