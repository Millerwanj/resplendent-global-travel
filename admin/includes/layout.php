...
<div class="admin-content">
    <header class="admin-topbar">
        ...
        <div><span>Client Engagement Suite</span><strong>v9.6 Production</strong></div>
    </header>
...
<script src="assets/admin.js?v=9.6.1" defer></script>
<?php foreach ($scripts as $script): ?>
<script src="<?= admin_e($script) ?>?v=9.6.1" defer></script>
<?php endforeach; ?>
</body>
</html>
<?php
